...
const Employee = () => {
    ...
    const GetEmployeeData = () => {
        ...
        const url = 'http://localhost:8081/STUDENT/get'
        axios.get(url)
            .then(response => {
    ...
    const handleSubmit = () => {
        ...
        const Credentials = { Name, Age, Email, PhoneNumber, RollNumber }
            ...
            <div className='model-box-view'>
                ...
                >
                    <Modal.Header closeButton>
                        <Modal.Title>View Student Data</Modal.Title>
                    </Modal.Header>
                    <Modal.Body>
                        <div>
                            ...
                            <div className='form-group mt-3'>
                                <input type="text" className='form-control' value={RowData.RollNumber} readOnly />
                            </div>
                            {
                                Delete && (
                ...
                >
                    ...
                    <Modal.Body>
                        <div>
                            ...
                            <div className='form-group mt-3'>
                                <input type="text" className='form-control' onChange={(e) => setEmail(e.target.value)} placeholder="Please enter email" />
                            </div>
                            <div className='form-group mt-3'>
                                <input type="text" className='form-control' onChange={(e) => setPhoneNumber(e.target.value)} placeholder="Please enter phonenumber" />
                            </div>
                            <div className='form-group mt-3'>
                                <input type="text" className='form-control' onChange={(e) => setRollNumber(e.target.value)} placeholder="Please enter rollnumber" />
                            </div>
                ...
                >
                    ...
                    <Modal.Body>
                        <div>
                            ...
                            <div className='form-group mt-3'>
                                <label>Email</label>
                                <input type="email" className='form-control' onChange={(e) => setAge(e.target.value)} placeholder="Please enter age" defaultValue={RowData.email} />
                            </div>
                            <div className='form-group mt-3'>
                                <label>Number</label>
                                <input type="text" className='form-control' onChange={(e) => setEmail(e.target.value)} placeholder="Please enter email" defaultValue={RowData.number}/>
                            </div>
                            <div className='form-group mt-3'>
                                <label>NIC</label>
                                <input type="text" className='form-control' onChange={(e) => setPhoneNumber(e.target.value)} placeholder="Please enter phonenumber" defaultValue={RowData.nic}/>
                            </div>
                            <div className='form-group mt-3'>
                                <label>Address</label>
                                <input type="text" className='form-control' onChange={(e) => setRollNumber(e.target.value)} placeholder="Please enter rollnumber" defaultValue={RowData.address}/>
                            </div>
                            <Button type='submit' className='btn btn-warning mt-4' onClick={handleEdit}>Edit Student Details</Button>
                        </div>
                    </Modal.Body>
                    <Modal.Footer>
